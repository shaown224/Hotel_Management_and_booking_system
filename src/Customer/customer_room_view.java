...
public class customer_room_view implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        try {
            ...
            ResultSet rs=connectDB.createStatement().executeQuery("SELECT * FROM `room` WHERE room.availability='Available' ORDER BY `room_number` ASC");
            while(rs.next()){
    ...
    private void funcBack() throws IOException {
        ...
        Parent root;
        root = FXMLLoader.load(getClass().getResource("cus_board.fxml"));
