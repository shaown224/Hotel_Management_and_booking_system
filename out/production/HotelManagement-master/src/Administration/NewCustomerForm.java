...
public class NewCustomerForm implements Initializable {
    ...
    void funcAdd(ActionEvent event) {
        ...
        DatabaseConnection connectNow= new DatabaseConnection();
        Connection connectDB=connectNow.getConnection();
        if (name.isEmpty() == false && number.isEmpty() == false && country.isEmpty() == false && checkIn.isEmpty() == false && gender.isEmpty()==false&& deposit.isEmpty()==false && gender.isEmpty()==false) {
